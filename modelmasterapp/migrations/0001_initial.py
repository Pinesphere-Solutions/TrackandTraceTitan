# Generated by Django 5.1.2 on 2025-07-03 06:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plating_color_internal', models.CharField(default='B', help_text='Short internal code used in stock number (e.g., B for Black)', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_draft', models.BooleanField(default=False, help_text='Draft Save')),
                ('is_save', models.BooleanField(default=False, help_text='Save')),
                ('delink_tray_id', models.CharField(blank=True, help_text='Delink Tray ID', max_length=100, null=True)),
                ('delink_tray_qty', models.IntegerField(blank=True, help_text='Delink Tray Quantity', null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejection_reason', models.TextField(help_text='Reason for rejection')),
                ('rejection_count', models.PositiveIntegerField(help_text='Count of rejected items')),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='nickle_audit_rejection_reasons', to='modelmasterapp.ip_rejectiongroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejection_reason', models.TextField(help_text='Reason for rejection')),
                ('rejection_count', models.PositiveIntegerField(help_text='Count of rejected items')),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='nickle_rejection_reasons', to='modelmasterapp.ip_rejectiongroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, help_text='Timestamp of the record')),
                ('brass_saved_time', models.DateTimeField(default=django.utils.timezone.now)),
