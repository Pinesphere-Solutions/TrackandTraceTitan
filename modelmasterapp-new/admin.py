...
admin.site.register(IP_TrayVerificationStatus)
...
admin.site.register(Nickle_Audit_Rejection_Table)
admin.site.register(Nickle_Audit_Rejection_ReasonStore)
admin.site.register(Nickle_Audit_Rejected_TrayScan)
admin.site.register(Nickle_Audit_Accepted_TrayScan)
admin.site.register(Nickle_Audit_Accepted_TrayID_Store)
